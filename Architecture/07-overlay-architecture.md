...
> Version: v0.2.1 | Trạng thái: Draft | Cập nhật: 2026-09-19
...
- [ ] Banner pause (`S9`, `PAUSE-0xx`) vẫn chưa thiết kế UX — ngoài phạm vi domain "Overlay & Force-close" của file này, để ở Đợt phụ trách Pause (`ROADMAP.md`).
